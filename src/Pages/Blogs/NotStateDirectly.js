        ...
        <div>
            <div className="card bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    <h2 className="card-title text-2xl">Why you do not set the state directly in React?</h2>
                    ...
                    <button className="btn btn-primary"><a href="https://www.bestinterviewquestion.com/question/why-should-we-not-update-the-state-directly-in-react-qxzqu5592op" target='_blank'>Read More</a></button>
                    </div>
                </div>
            </div>
        </div>
