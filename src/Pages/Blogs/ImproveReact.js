        ...
        <div>
            <div className="card bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    <h2 className="card-title text-2xl">How will you improve the performance of a React Application?</h2>
                    ...
                    <button className="btn btn-primary"><a href="https://blog.logrocket.com/optimizing-performance-react-application/" target='_blank'>Read More</a></button>
                    </div>
                </div>
            </div>
        </div>
